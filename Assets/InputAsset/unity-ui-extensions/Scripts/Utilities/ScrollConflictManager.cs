...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ScrollConflictManager : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        public HorizontalScrollSnap ParentScrollHSnap;
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            if (scrollOtherHorizontally)
            {
                if (horizontal > vertical)
                {
                    ...
                    //ParentScrollHSnap.OnBeginDrag(eventData);
                }
            }
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            if (scrollOther)
            {
                ...
                //ParentScrollHSnap.OnEndDrag(eventData);
            }
        }
        ...
        public void OnDrag(PointerEventData eventData)
        {
            if (scrollOther)
            {
                ...
                //ParentScrollHSnap.OnDrag(eventData);
            }
        }
    }
}